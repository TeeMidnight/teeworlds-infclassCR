...
/* INFECTION MODIFICATION START ***************************************/
	...
	SetFireDelay(INFWEAPON_MAGICIAN_GUN, GetFireDelay(INFWEAPON_GUN));
	...
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_GUN, 1000);
	SetAmmoRegenTime(INFWEAPON_MAGICIAN_GRENADE, 30000);
	...
	SetMaxAmmo(INFWEAPON_MAGICIAN_GUN, 10);
