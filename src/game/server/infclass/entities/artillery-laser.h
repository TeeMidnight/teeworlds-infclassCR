...
public:
	...
	void FillAirStrike(bool IsSuperWeapon)
	{
		...
		m_AirStrikeRange = IsSuperWeapon ? g_Config.m_InfAirStrikeRangeSuper : g_Config.m_InfAirStrikeRange;
		m_AirStrikeDeley = IsSuperWeapon ? g_Config.m_InfAirStrikeDeleySuper : g_Config.m_InfAirStrikeDeley;
