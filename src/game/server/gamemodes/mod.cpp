...
void CGameControllerMOD::Snap(int SnappingClient)
{
	...
	pGameInfoEx->m_Flags = GAMEINFOFLAG_PREDICT_VANILLA | GAMEINFOFLAG_DONT_MASK_ENTITIES | GAMEINFOFLAG_GAMETYPE_VANILLA | GAMEINFOFLAG_ENTITIES_DDNET | GAMEINFOFLAG_ALLOW_HOOK_COLL;
