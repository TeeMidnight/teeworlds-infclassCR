...
MACRO_CONFIG_STR(SvMaprotation, sv_maprotation, 768, "infc_lunaroutpost infc_headquarter_v2 infc_newdust_v2 infc_skull infc_warehouse infc_damascus infc_eidalfitr infc_newdust infc_olddust infc_halfdust infc_terraria infc_rminecraft infc_minecraft infc_nether infc_skyland infc_land infc_hardcorepit infc_normandie infc_deathdealer infc_bamboo3 infc_halfdust infc_warehouse2 infc_headquarter infc_darkcave infc_darkcave_v2 infc_toilet infc_toilet_v2 infc_half_provence infc_wonderlands_mini infc_canyon infc_k9f_small infc_malinalli_k9f infc_skull_mini infc_towers infc_floatingislands infc_the_end", CFGFLAG_SERVER, "Maps to rotate between")
